...
from scrape_filmpolski_years import extract_films_from_html, extract_movie_details_from_html
...
<li><div class="film_tech3">Lokacje: Świnoujście, Międzyzdroje, Łódź.</div></li>
</ul>
...
<li><div class="ekipa_funkcja wyroznienie">Reżyseria</div><div class="ekipa_osoba wyroznienie"><a href="index.php/1193213">Maciej Kawalski</a></div><div class="ekipa_opis wyroznienie">&nbsp;</div></li>
...
<li><div class="ekipa_funkcja wyroznienie">Obsada aktorska</div><div class="ekipa_osoba wyroznienie"><a href="index.php/114681">Arkadiusz Jakubik</a></div><div class="ekipa_opis wyroznienie">psycholog więzienny Rafał Wejman</div><div class="ekipa_osoba"><a href="index.php/1119917">Maja Ostaszewska</a></div><div class="ekipa_opis">Magda Wejman</div></li>
</ul>
</article>
'''
...
class ParserTests(unittest.TestCase):
    ...
    def test_extract_movie_details(self):
        ...
        self.assertEqual(["Świnoujście", "Międzyzdroje", "Łódź"], details["locations"])
        ...
        self.assertEqual(["Maciej Kawalski"], details["directors"])
        self.assertEqual(["Łukasz Światowiec"], details["screenwriters"])
        self.assertEqual(["Piotr Sobociński jr"], details["cinematographers"])
        self.assertEqual("Arkadiusz Jakubik", details["cast_main"][0]["name"])
        self.assertEqual("Maja Ostaszewska", details["cast_other"][0]["name"])
